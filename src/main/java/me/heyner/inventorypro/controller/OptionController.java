...
public class OptionController {
    ...
    public Option updateOption(@PathVariable Long productId, @PathVariable int optionIndex, @RequestBody @Valid Option option) {
    ...
    public List<OptionValue> getOptionValues(@PathVariable Long productId, @PathVariable int optionIndex) {
        return optionService.getOption(productId, optionIndex).getValues();
    }

    @PostMapping("/products/{productId}/options/{optionIndex}/values")
    public OptionValue addOptionValue(@PathVariable Long productId, @PathVariable int optionIndex, @RequestBody @Valid OptionValue optionValue) {
    ...
    public OptionValue getOptionValue(@PathVariable Long productId, @PathVariable int optionIndex, @PathVariable int optionValueIndex) {
    ...
    public OptionValue updateOptionValue(@PathVariable Long productId, @PathVariable int optionIndex,@PathVariable int optionValueIndex, @RequestBody @Valid OptionValue optionValue) {
    ...
    public void deleteOptionValue(@PathVariable Long productId, @PathVariable int optionIndex, @PathVariable int optionValueIndex) {
